...
namespace SAM.Core.Mollier
{
    public static partial class Query
    {
        ...
        public static Dictionary<double, List<MollierPoint>> ConstantRelativeHumidityPoints(double temperature_Min, double temperature_Max, double pressure, int relativeHumidity_Step = 10, double humidityRatio_Min = Default.HumidityRatio_Min, double humidityRatio_Max = Default.HumidityRatio_Max)
        {
