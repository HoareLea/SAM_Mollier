namespace SAM.Core.Mollier
{
    ...
    public static class Zero
    {
        ...
        /// <summary>
        /// Specific Heat of water vapour at constant pressure and temperature  0C (cpw) [J/kg*K]
        /// </summary>
        public const double SpecificHeat_WaterVapour = 1860;  //1859

        /// <summary>
        /// Specific Heat of air vapour at constant pressure and temperature 0C (cp) [J/kg*K]
        /// </summary>
        public const double SpecificHeat_Air = 1010; //1006

        /// <summary>
        /// Specific Heat of water vapour at constant pressure and temperature 0C (cw) [J/kg*K]
        /// </summary>
        public const double SpecificHeat_Water = 4190;  //4219.9

        /// <summary>
        /// Specific Heat of ice at constant pressure and temperature 0C (c_ice) [J/kg*K]
        /// </summary>
