...
namespace SAM.Core.Mollier
{
    public static partial class Query
    {
        ...
        public static double SaturationVapourPressure(double dryBulbTemperature)
        {
            ...
            {
                return 611.213 * Math.Log(0.07257 * dryBulbTemperature - 0.0002937 * Math.Pow(dryBulbTemperature, 2) + 0.000000981 * Math.Pow(dryBulbTemperature, 3) - 0.000000001901 * Math.Pow(dryBulbTemperature, 4));
            }
