...
using SAM.Weather.Grasshopper.Mollier.Properties;
using SAM.Core.Grasshopper;
using System;
using System.Collections.Generic;

namespace SAM.Weather.Grasshopper.Mollier
{
    public class SAMWeatherMollierPoints : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            if (index != -1)
            {
                List<Core.Grasshopper.Mollier.GooMollierPoint> gooMollierPoints = mollierPoints?.ConvertAll(x => new Core.Grasshopper.Mollier.GooMollierPoint(x));
