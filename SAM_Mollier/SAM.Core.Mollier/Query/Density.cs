namespace SAM.Core.Mollier
{
    public static partial class Query
    {
        ...
        public static double Density_ByHumidityRatio(double dryBulbTemperature, double humidityRatio, double pressure)
        {
            ...
            return (1 + humidityRatio) / (saturationHumidityRatio + 0.6222) * pressure / (Constant.GasConstant_WaterVapour * (dryBulbTemperature + Unit.ConversionFactor_Kelvin)); //Equation 2.20 Gluck
        }
