    ...
    public class SAMMollierCreateCoolingProcessByTemperatureDifference : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_temperatureDifference", NickName = "_temperatureDifference", Description = "TemperatureDifference [°C]", Access = GH_ParamAccess.item}, ParamVisibility.Binding));
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            CoolingProcess coolingProcess = Core.Mollier.Create.CoolingProcess(mollierPoint, temperatureDifference);
