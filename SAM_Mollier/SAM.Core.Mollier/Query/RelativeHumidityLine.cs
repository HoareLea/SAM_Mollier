...
namespace SAM.Core.Mollier
{
    public static partial class Query
    {
        ...
        public static Dictionary<double, List<MollierPoint>> RelativeHumidityLine(int temperature_Min, int temperature_Max, double pressure, int relativeHumidity_Step = 10, double humidityRatio_Min = Default.HumidityRatioMin, double humidityRatio_Max = Default.HumidityRatioMax)
        {
