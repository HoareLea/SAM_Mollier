...
namespace SAM.Core.Mollier
{
    ...
    { 
        public static Dictionary<double, List<MollierPoint>> ConstantSpecificVolumePoints(double specific_volume_Min = Default.SpecificVolume_Min, double specific_volume_Max = Default.SpecificVolume_Max, double pressure = Standard.Pressure, double specificVolumeStep = 0.05, double dryBulbTemperature_Min = Default.DryBulbTemperature_Min, double dryBulbTemperature_Max = Default.DryBulbTemperature_Max, double humidityRatio_Min = Default.HumidityRatio_Min, double humidityRatio_Max = Default.HumidityRatio_Max)
        {
